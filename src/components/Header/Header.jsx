      ...
      <div className="container-disconnect-profil">
        <div className="disconnect-img">
          <svg width="32" height="32" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g>
              <path className="st0" d="M28,49C16.4,49,7,39.6,7,28c0-6.7,3.3-13.1,8.7-17c0.9-0.6,2.1-0.4,2.8,0.5c0.6,0.9,0.4,2.1-0.5,2.8
              ...
              <path className="st0" d="M28,27.5L28,27.5c-1.2,0-2.2-1-2.2-2.2V9.2C25.8,8,26.8,7,28,7h0c1.2,0,2.2,1,2.2,2.2v16.1
