 ...
 * 
 * @param {object} props
 * @var {object[int]} dailyExpensesDatas  
 * @var {object[int]} dailyGainDatas  
 * 
 * @returns {JSX.Element}
 */

//Apexcharts series Datas for every months
var dailyExpensesDatas = [0, 0, 55, 30, 0, 0, 0, 98, 130, 120, 410, 310]
var dailyGainDatas = [0, 0, 64, 42, 76, 98, 145, 65, 124, 43, 45, 87]
